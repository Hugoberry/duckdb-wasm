...
set(DUCKDB_EXTENSIONS "fts;excel;json;pbix")
...
ExternalProject_Add(
  ...
  BUILD_BYPRODUCTS
    ...
    /home/boom/git/hub/duckdb-pbix-extension/build/wasm_eh/extension/pbix/libpbix_extension.a)
...
add_library(duckdb_pbix STATIC IMPORTED)
set_property(TARGET duckdb_pbix PROPERTY IMPORTED_LOCATION /home/boom/git/hub/duckdb-pbix-extension/build/wasm_eh/extension/pbix/libpbix_extension.a)
target_include_directories(duckdb_pbix INTERFACE /home/boom/git/hub/duckdb-pbix-extension/src/include)
...
add_dependencies(duckdb_pbix duckdb_ep)
